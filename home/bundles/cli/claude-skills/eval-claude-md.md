...
Then summarize:
- Which CLAUDE.md content had the highest ROI (biggest reduction in exploration)
...
If CLAUDE.md doesn't exist yet, skip step 2 and instead run the "without" condition, then **draft** a CLAUDE.md based on what the agents needed most, and run step 3 with the draft. End with recommendations.
